...
//    boolean b = false;
//    @Override
//    public void executeStrategy(Optional<PredictionEngine.SequenceCandlesPrediction> pred, @NotNull SequenceCandles visibleCandles, @NotNull TradingManager openOperations) {
//        openOperations.computeHasOpenOperation(op -> {
//            if (op.getCandlesOpen() >= 3) openOperations.close(TradingManager.ExitReason.STRATEGY);
//            op.setSlPercent(2);
//            op.addTpPercent(1);
//        });
//        if (b) return;
