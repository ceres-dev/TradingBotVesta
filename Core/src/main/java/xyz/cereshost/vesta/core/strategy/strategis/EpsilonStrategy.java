...
//        }
//
//        operations.open(direction, amountUsdt, LEVERAGE);
//    }
//
...
//            return operations.getOpenPosition().getDireccion() == direction;
//        }
//        return false;
//    }
//
...
//        if (!closeOperation.isProfit()) operations.open(closeOperation.getDireccion().inverse(), 2, LEVERAGE);
//    }
//
//    @Override
